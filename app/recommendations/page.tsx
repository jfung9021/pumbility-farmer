  ...
  return (
    <main className="recommendations-page">
      ...
      <footer>
        ...
        <p>The underlying Co-op tier model adjusts miss points for player strength and Phoenix source using all observations, then estimates the conditional 75th-percentile score for a median-strength Phoenix 2 player. The conditional quantile supplies outlier robustness without trimming raw scores or residuals. Chart order anchors the easiest chart at continuous difficulty 10, the median chart at 16, and the hardest chart at 23.9, then truncates the published difficulty to a whole-number range from 10 through 23 without forcing a normal distribution.</p>
